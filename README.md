...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            color: #333;
            background: linear-gradient(to bottom, #000000, #007bff); /* Gradasi dari hitam ke biruan */
            overflow: hidden; /* Sembunyikan scrollbar */
            position: relative; /* Untuk posisi konten */
        }
        @keyframes fadeIn {
            from { opacity: 0; }
            to { opacity: 1; }
        ...
        h1 {
            ...
            margin-bottom: 20px;
            color: #007bff;
            animation: fadeInText 0.5s ease-in; /* Animasi muncul untuk judul */
        }
